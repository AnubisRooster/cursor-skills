...
description: >
  ...
  merge request workflows, and repository standardization tasks. Apply when users
  ask to publish skills, sync operational docs, open MRs, or automate codebase
  updates in self-hosted or cloud GitLab.
---
